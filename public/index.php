...
<body>
    <div class="container">
        ...
        <form method="POST" action="index.php">
            ...
            if (isset($_POST['check_voucher'])) {
                ...
                if ($voucherData) {
                    ...
                    echo "<p>Mã Phiếu Thông Tin không tồn tại.</p>";
                }
            }
        ...
        if (isset($_POST['save_voucher']) && !$isLocked) {
            ...
            if ($voucherModel->getVoucherByCode($maPhieu)) {
                if ($voucherModel->isVoucherLocked($maPhieu)) {
                    echo "<p>Phiếu này đã được lưu trước đó. Vui lòng nhập mã phiếu khác.</p>";
                } else {
                    ...
                    if ($maPhieu && $tenCoSo && $soDienThoai && $tenChuTaiKhoan && $tenNganHang && $soTaiKhoan && $diaChiMua) {
                        ...
                        echo "<p>Thông tin phiếu đã được lưu thành công và dữ liệu đã bị khóa.</p>";
                    } else {
                        echo "<p>Có lỗi xảy ra, một hoặc nhiều trường không có giá trị.</p>";
                    }
                }
            } else {
                echo "<p>Mã Phiếu Thông Tin không tồn tại hoặc không hợp lệ.</p>";
            }
        }
        ?>
    </div>
